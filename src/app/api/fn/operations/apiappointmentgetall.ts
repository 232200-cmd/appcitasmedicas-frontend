...
export interface Apiappointmentgetall$Params {}

export function apiappointmentgetall(http: HttpClient, rootUrl: string, params?: Apiappointmentgetall$Params, context?: HttpContext): Observable<StrictHttpResponse<void>> {
